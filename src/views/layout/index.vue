...
<el-container>
  ...
  <el-aside class='left' style='width:220px'>
    ...
    <!-- 左侧菜单 el-menu有一个router控制路由，启用该模式会在激活导航时以index为path进行路由跳转 -->
    <el-menu router style='width:221px' background-color='#323745' text-color='#adafb5' active-text-color=' #ffd04b'>
      <!-- 一级菜单 -->
